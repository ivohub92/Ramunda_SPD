...
void setup()
{
  ...
  pinMode(BOTONTEMP, INPUT_PULLUP);
...
int botonPresionado(void)
{
  ...
  */
  ...
  lectura_boton_reset = digitalRead(BOTONRESET);
   lectura_boton_temp = digitalRead(BOTONTEMP);
  ...
  if(lectura_boton_reset == 0 && lectura_boton_reset != resetPrevio)
  {
   ...
   if(lectura_boton_temp == 0 && lectura_boton_temp != tempPrevia)
  {
    tempPrevia = lectura_boton_temp;
